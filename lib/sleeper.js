...
export async function getWeeklyMatchupData(leagueId) {
  ...
  // Usamos la semana anterior a la actual, porque la semana "actual" según
  // Sleeper puede seguir en curso (partidos sin terminar todavía).
  const week = Math.max((state.week || 1) - 1, 1);
